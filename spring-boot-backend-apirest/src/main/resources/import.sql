...
insert into regionesdto values (1,'Lima');
insert into regionesdto values (2,'Callao');
insert into regionesdto values (3,'Arequipa');
insert into regionesdto values (4,'Tacna');
...
INSERT INTO estados (id, nombre) VALUES (2, 'ANULADO');
INSERT INTO estados (id, nombre) VALUES (3, 'BLOQUEADO');

INSERT INTO clientes (region_id, nombre, apellido, email, create_at) VALUES(1, 'Andres', 'Guzman', 'profesor@rentas.com', '2018-01-01');
...
INSERT INTO usuarios (username, password, enabled, nombre, apellido, email) VALUES ('andres','$2a$10$C3Uln5uqnzx/GswADURJGOIdBqYrly9731fnwKDaUdBkt/M3qvtLq',true, 'Andres', 'Guzman','profesor@rentas.com');
INSERT INTO usuarios (username, password, enabled, nombre, apellido, email) VALUES ('admin','$2a$10$RmdEsvEfhI7Rcm9f/uZXPebZVCcPC7ZXZwV51efAvMAp1rIaRAfPK',true, 'John', 'Doe','jhon.doe@rentas.com');
...
INSERT INTO entidades (codpos,nombre,alias,ruc,region_id,status_id,create_user ,modify_user ,create_at ,update_at ) values ('150119', 'MUNICIPALIDAD DE LURIN','LURIN','10210011',1,2,1,1,'2010-02-04 00:00:00','2022-01-25 00:00:00');